...
class ClosestFarthest(QgsProcessingAlgorithm):
    ...
    def displayName(self):
        return self.tr(
            "Closest and farthest pair of Points",
            "Tìm cặp điểm gần nhất và xa nhất của một tập điểm",
        )
    ...
    def tags(self):
        return self.tr(
            "Closest pair of points, fartherst pair of points, voronoi diagram"
        ).split(",")
    ...
    def icon(self):
        return QIcon(
            os.path.join(
                ...
                "images/vect_closestfarthest.png",
            )
        )
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        closest.dataProvider().addAttributes(
            [QgsField("length", QVariant.Double)]
        )  # define/add field data type
        ...
        farthest.dataProvider().addAttributes(
            [QgsField("length", QVariant.Double)]
        )  # define/add field data type
        ...
        return {
            self.CLOSEST: closest_pair["OUTPUT"],
