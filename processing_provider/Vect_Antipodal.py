...
from becagis.becagislibrary.latlong import antipode
import processing
import os
...
class Antipodal(QgsProcessingAlgorithm):
    ...
    def icon(self):
        return QIcon(
            os.path.join(
                os.path.dirname(os.path.dirname(__file__)), "images/vect_antipode.png"
            )
        )
    ...
    def shortHelpString(self):
        ...
        footer = (
            '''<div align="center">
                      <img src="'''
            + os.path.join(os.path.dirname(os.path.dirname(__file__)), self.figure1)
            + '''">
                      <img src="'''
            + os.path.join(os.path.dirname(os.path.dirname(__file__)), self.figure2)
            + """">
                    </div>
                    <div align="right">
                      <p align="right">
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterFeatureSink(
                self.OUTPUT, self.tr("Antipodal Layer", "Antipodal Layer")
            )
        )
