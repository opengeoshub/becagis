...
class Mic(QgsProcessingAlgorithm):
    ...
    def icon(self):
        return QIcon(
            os.path.join(
                os.path.dirname(os.path.dirname(__file__)), "images/vect_mic.png"
            )
        )
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterVectorDestination(
                self.CENTER, self.tr("Center of MIC", "Center of MIC")
            )
        )
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        if feature_count <= 0:
            ...
            for id in ids:
                ...
                selected_feature = QgsProcessingFeatureSourceDefinition(
                    input_layer.id(), True
                )
            ...
            center = processing.run(
                ...
                {"LAYERS": mem_layers, "OUTPUT": parameters[self.CENTER]},
            ...
            return {self.CENTER: center["OUTPUT"], self.MIC: _mic["OUTPUT"]}
