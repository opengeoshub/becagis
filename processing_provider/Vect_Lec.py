...
class Lec(QgsProcessingAlgorithm):
    ...
    def icon(self):
        return QIcon(
            os.path.join(
                os.path.dirname(os.path.dirname(__file__)), "images/vect_Lec.png"
            )
        )
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterVectorDestination(
                ...
                self.CENTER,
                self.tr(
                    "Center of the Largest Empty Circle", "Tâm đường tròn rỗng lớn nhất"
                ),
            )
        )
